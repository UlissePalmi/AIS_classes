...
with the market and its positive annualized return of 3.38%. The annualized volatility is 9.50%,
producing a Sharpe ratio of 0.3560. However, this level of risk-adjusted performance is not strong
...
to have a positive monthly alpha of 0.2829\% with a statistically significant p-value of 0.013, while its
market beta is almost zero. However, once we control for additional factors using the Carhart model,
the alpha becomes economically small and statistically insignificant. The intercept is -0.01\% per
month with a p-value of 0.878, while the UMD coefficient is large and highly significant. This suggests
